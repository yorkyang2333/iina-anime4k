...
sys_word_map = {
    ...
    "cs": "Výchozí systémový",
    "da": "Systemstandard",
    "de": "Systemstandard",
    "el": "Προεπιλογή συστήματος",
    "en": "System Default",
    "en-GB": "System Default",
    ...
    "hi": "सिस्टम डिफ़ॉल्ट",
    "hr": "Zadano u sustavu",
    "hu": "Rendszer alapértelmezett",
    "hy": "Համակարգի լռելյայն",
    "id": "Bawaan Sistem",
    "is": "Sjálfgefið í kerfi",
    "it": "Predefinito di sistema",
    "ja": "システムデフォルト",
    "kn": "ಸಿಸ್ಟಮ್ ಡೀಫಾಲ್ಟ್",
    "ko": "시스템 기본값",
    "lv": "Sistēmas noklusējums",
    "mk": "Системски стандардно",
    "ml": "സിസ്റ്റം ഡിഫോൾട്ട്",
    "ne": "प्रणाली पूर्वनिर्धारित",
    "nl": "Systeemstandaard",
    "no": "Systemstandard",
    "pl": "Domyślny systemowy",
    "pt": "Padrão do sistema",
    "pt-BR": "Padrão do sistema",
    "ro": "Implicit în sistem",
    "ru": "По умолчанию",
    "sk": "Predvolené systémom",
    "sl": "Sistemsko privzeto",
    "sr": "Подразумевано у систему",
    "sr-Latn": "Podrazumevano u sistemu",
    "sv": "Systemstandard",
    "ta": "கணினி இயல்புநிலை",
    "th": "ค่าเริ่มต้นระบบ",
    "tr": "Sistem Varsayılanı",
    "ug": "سېستىما سۈكۈتتىكىسى",
    "uk": "За замовчуванням",
    "ur": "سسٹم ڈیفالٹ",
