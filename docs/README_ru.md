...
* ⚖️ **Два уровня качества (Quality Tiers)**:
  * **Fast**: Легковесный и быстрый режим, оптимизированный для процессоров Apple Silicon (M1/M2) и Intel Mac.
  * **HQ**: Продвинутые многопроходные цепочки шейдеров для производительных видеокарт (M1 Pro/Max/Ultra и мощнее).
